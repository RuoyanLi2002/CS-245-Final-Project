...
def main():
    ...
    merge_business_data(filtered_businesses, None, None, os.path.join(args.output_dir, 'item.json'))
    merge_review_data(filtered_reviews, None, None, os.path.join(args.output_dir, 'review.json'))
    create_unified_users(filtered_users, None, None, os.path.join(args.output_dir, 'user.json'))
